	...
	<body>
		<table style="width: 591.0px;margin: 0.0pt auto;font-family: verdana;font-size: 13.0px;color: rgb(107,109,110);line-height: 20.0px;">
		   <tbody>
			  ...
			  <tr>
				 <td style="font-weight: bold;font-size: 17.0px;color: rgb(0,86,150);vertical-align: bottom;min-height: 23.0px;letter-spacing: -0.3px;">Hello <a href="mailto:{{ $user->email}}" target="_blank">{{ $user->first_name }} </a>!</td>
			  </tr>
			  <tr>
				 <td>
					<p>{{ $employer->first_name }}</p>
					<p><a href="{{ route('account.setup', $token) }}" target="_blank">Set password</a></p>
				 </td>
			  </tr>
			  <tr>
