	...
	<body>
		<table style="width: 591.0px;margin: 0.0pt auto;font-family: verdana;font-size: 13.0px;color: rgb(107,109,110);line-height: 20.0px;">
		   <tbody>
			  ...
			  <tr>
				 <td>
					<p>You are receiving this email because you are not complete signup process at Team.Education. please follow the link below: </p>
					<p><a href="{{ app('url')  }}/auth/employer" target="_blank">Complete Signup Process</a></p>
				 </td>
			  </tr>
			  <tr>
