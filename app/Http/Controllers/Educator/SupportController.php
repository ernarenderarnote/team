...
class SupportController extends Controller
{
    ...
    {
        $this->data["subjects"] =  SupportSubject::whereType('educator')->get();
        $this->data["supports"] = Additional::whereType('educator.support.contact')->first();

        return view('educator.support.create', $this->data);
    }
    ...
    public function store(Request $request)
    {
        ...
        $supports = Additional::whereType('educator.support.contact')->first();
        ...
        return redirect()->route('educator.support.create');
    }
